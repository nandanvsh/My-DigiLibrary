...
$query = "SELECT * FROM peminjaman JOIN member ON peminjaman.member_id = member.member_id JOIN lms_book_details ON lms_book_issue.BOOK_CODE = lms_book_details.BOOK_CODE ORDER BY BOOK_ISSUE_NO ASC";
